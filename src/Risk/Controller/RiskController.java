...
<<<<<<< HEAD
    ...
    private void initComponents() {
        ...
        */ jPanel3 = new RiskPlayerPanelViewController(risk);
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance().getContext().getResourceMap(RiskController.class);
    ...
    public static void ShowGUI() {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() { new RiskController().setVisible(true);}
        });
    }
...
=======
	...
	private void initComponents() {
		...
		org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application
				...
				.getResourceMap(RiskController.class);
		setTitle(resourceMap.getString("Form.title")); // NOI18N
		setBackground(resourceMap.getColor("Form.background")); // NOI18N
		setForeground(resourceMap.getColor("Form.foreground")); // NOI18N
		setName("Form"); // NOI18N
		...
		statusLabel.setFont(resourceMap.getFont("statusLabel.font")); // NOI18N
		statusLabel.setForeground(resourceMap
				.getColor("statusLabel.foreground")); // NOI18N
		statusLabel.setText(resourceMap.getString("statusLabel.text")); // NOI18N
		statusLabel.setName("statusLabel"); // NOI18N
		jPanel3.add(statusLabel,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(132, 63, 427,
						-1));
		...
		jPanel3.add(AttackButton,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 10, 89,
						-1));
		...
		jPanel3.add(EndButton,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 10, -1,
						-1));
		...
		jPanel3.add(FortifyButton,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(661, 10, 90,
						-1));
		...
		jPanel3.add(CardButton,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(438, 10, 90,
						-1));
	...
	private void EndButtonMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_EndButtonMouseClicked
		...
		risk.active = risk.curPlayer;
		jPanel3.repaint();
		statusLabel.setText("Recieved a bonus of "
				+ risk.curPlayer.getNumberOfArmies());
		AttackButton.setVisible(false);
		EndButton.setVisible(false);
		FortifyButton.setVisible(false);
		risk.drawn = false;
	...
	public void mouseClicked(MouseEvent me) {
		...
		if (risk.getState() == RiskGameModel.REINFORCE) {
			name = risk.curPlayer.getName();
			risk.gamePhaseActive(x, y);
			statusLabel.setText("You have "
					+ risk.curPlayer.getNumberOfArmies() + " left to place");
			if (risk.curPlayer.getNumberOfArmies() == 0) {
				risk.setState(RiskGameModel.ACTIVE_TURN);
			}
		...
		if (risk.getState() == RiskGameModel.ATTACK_PHASE) {
			...
			// If defenders turn
				...
				if (numofatt > 0) {
					...
					risk.engageBattle();
					if (defenseArmies - risk.dTerritory.getArmies() == 1)
						statusLabel.setText(risk.curPlayer.getName()
								+ " has destroyed an army");
					else if (defenseArmies - risk.dTerritory.getArmies() == 2)
						statusLabel.setText(risk.curPlayer.getName()
								+ " has destroyed two armies");
					else if (attackArmies - risk.aTerritory.getArmies() == 1)
						statusLabel.setText(risk.curPlayer.getName()
								+ " has lost an army");
					else if (attackArmies - risk.aTerritory.getArmies() == 2)
		...
		if (risk.getState() == RiskGameModel.CAPTURE) {
			...
			if (x > 460 && x < 545) {// move has ben clicked
				if (y > 325 && y < 355) {// then occupy the territory
					AttackButton.setVisible(true);
					if (risk.defenseNum == 1)
						statusLabel.setText("1 army moved to "
								+ risk.dTerritory.getName());
					else
						statusLabel.setText(risk.defenseNum
								+ " armies moved to "
								+ risk.dTerritory.getName());
...
>>>>>>> db02659760db4e2c745ee68930e05ea1375810e1
