...
public class RiskGameModeController extends java.awt.Frame {
	...
	private void initComponents() {
		...
		gl_modePanel.setHorizontalGroup(gl_modePanel.createParallelGroup(Alignment.LEADING).addGroup(gl_modePanel
				.createSequentialGroup()
				.addGroup(gl_modePanel.createParallelGroup(Alignment.LEADING).addGroup(gl_modePanel
						.createSequentialGroup().addGap(174)
						.addGroup(gl_modePanel.createParallelGroup(Alignment.TRAILING, false)
								.addComponent(btnSingleMode, Alignment.LEADING, GroupLayout.DEFAULT_SIZE,
										GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(btnTournamentMode, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 154,
										Short.MAX_VALUE)))
						.addGroup(gl_modePanel.createSequentialGroup().addGap(150).addComponent(lblChooseTheMode)))
				.addContainerGap(185, Short.MAX_VALUE)));
		gl_modePanel.setVerticalGroup(gl_modePanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_modePanel.createSequentialGroup().addContainerGap().addComponent(lblChooseTheMode)
						.addGap(60).addComponent(btnSingleMode).addGap(28).addComponent(btnTournamentMode)
