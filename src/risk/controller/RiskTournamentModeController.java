...
public class RiskTournamentModeController extends java.awt.Frame {
	...
	private void initComponents() {
		...
		gl_modePanel.setHorizontalGroup(gl_modePanel.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_modePanel.createSequentialGroup().addGap(156).addComponent(lblTournamentMode)
						.addContainerGap(215, Short.MAX_VALUE))
				.addGroup(gl_modePanel.createSequentialGroup().addContainerGap(570, Short.MAX_VALUE)
						.addComponent(tournamentModeDone).addGap(72))
				.addGroup(Alignment.LEADING, gl_modePanel.createSequentialGroup().addGap(88)
						.addGroup(gl_modePanel.createParallelGroup(Alignment.LEADING).addComponent(lblMap)
								...
								.addComponent(lblMaximumNumberOf, GroupLayout.PREFERRED_SIZE, 176,
										GroupLayout.PREFERRED_SIZE))
						.addGap(69)
						.addGroup(gl_modePanel.createParallelGroup(Alignment.LEADING)
								.addComponent(turnNumCombobox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(gameNumCombobox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(playerNumCombobox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(mapNumCombobox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE))
						.addContainerGap(326, Short.MAX_VALUE)));
		gl_modePanel.setVerticalGroup(gl_modePanel.createParallelGroup(Alignment.TRAILING).addGroup(gl_modePanel
				.createSequentialGroup().addGap(28).addComponent(lblTournamentMode).addGap(38)
				.addGroup(gl_modePanel
						.createParallelGroup(Alignment.BASELINE).addComponent(lblMap).addComponent(mapNumCombobox,
								GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
				.addGap(31)
				.addGroup(gl_modePanel
						.createParallelGroup(Alignment.BASELINE).addComponent(lblPlayer).addComponent(playerNumCombobox,
								GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
				.addGap(28)
				.addGroup(gl_modePanel.createParallelGroup(Alignment.BASELINE).addComponent(lblGame)
						.addComponent(gameNumCombobox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE))
				.addPreferredGap(ComponentPlacement.RELATED, 29, Short.MAX_VALUE)
				.addGroup(gl_modePanel.createParallelGroup(Alignment.BASELINE).addComponent(lblMaximumNumberOf)
						.addComponent(turnNumCombobox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE))
				.addGap(15).addComponent(tournamentModeDone).addGap(21)));
	...
	private void startGame() {
		...
		gameplayers.add(new RiskPlayerModel("PLayer1", 1, new Aggressive()));
		gameplayers.add(new RiskPlayerModel("PLayer2", 2, new risk.model.strategy.Random()));
		gameplayers.add(new RiskPlayerModel("PLayer3", 3, new Cheater()));
